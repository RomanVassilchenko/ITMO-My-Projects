# Лабораторная работа 4, вариант 8432 (Поменял Angular на React)
...
* "Планшетный" - для устройств, ширина экрана которых равна или превышает 852, но меньше 1024 пикселей.
* "Мобильный"- для устройств, ширина экрана которых меньше 852 пикселей.
