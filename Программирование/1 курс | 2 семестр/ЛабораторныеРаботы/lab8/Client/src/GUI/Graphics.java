...
public class Graphics extends JPanel implements ActionListener {
    ...
    int rotation = 0;
    ArrayList<Rectangle> workerRectangles;
    Dimension size;
    Thread updateThread;
    String language;
    public Graphics(ClientEvents clientEvents, Dimension size,String languageIn) {
        ...
        this.workerRectangles = new ArrayList<Rectangle>();
        this.size = size;
        ...
        addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                int m_x = e.getX();
                double m_y = e.getY();
                Iterator<Rectangle> i = workerRectangles.iterator();
                while (i.hasNext()) {
                    Shape s = i.next();
    ...
    protected void paintComponent(java.awt.Graphics g) {
        ...
        for (Map.Entry<Integer, Worker> entry : clientManager.getCollectionForTable()
            ...
            WorkerRectangle rect = new WorkerRectangle(worker,startX,startY);
