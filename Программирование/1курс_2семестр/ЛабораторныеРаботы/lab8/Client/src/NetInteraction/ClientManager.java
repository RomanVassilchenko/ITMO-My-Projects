...
public class ClientManager {
    ...
    public void printCollection(Command command, JTextArea outputPanel) {
        command.getStrings().forEach(x -> outputPanel.append(x + "\n"));
    }
    ...
    public void printString(Command command, JTextArea outputPanel) {
    ...
    public Command interact(Command commandFromGUI) throws IOException, ClassNotFoundException {
        ...
        switch (commandIn.getUserCommand()) {
            case "not reg" -> {
                login = null;
                password = null;
            ...
            case "getCollectionForTable" -> collectionForTable = commandIn;
            default -> conditionOfAuthorization = "auth";
        }
        return commandIn;
    }
